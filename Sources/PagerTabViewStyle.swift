...
public enum PagerStyle {
    ...
    case scrollableBarButton(indicatorBarHeight: CGFloat = 2, indicatorBarColor: Color = .blue,
                             padding: EdgeInsets = EdgeInsets(top: 5, leading: 10, bottom: 0, trailing: 10),
                             tabItemSpacing: CGFloat = 0, tabItemHeight: CGFloat = 60, placedInToolbar: Bool = false, showBottomDivider: Bool = false, font: Font = .subheadline.bold())
    ...
    internal var tabItemSpacing: CGFloat {
        ...
        case .barButton(_, _, let spacing, _, _):
            return spacing
        case .scrollableBarButton(_, _, _, let spacing, _, _, _, _):
            return spacing
    ...
    internal var indicatorBarColor: Color {
        ...
        case .barButton(_, let color, _, _, _):
            return color
        case .scrollableBarButton(_, let color, _, _, _, _, _, _):
            return color
        case .custom:
    ...
    internal var indicatorBarHeight: CGFloat {
        ...
        case .barButton(let height, _, _, _, _):
            return height
        case .scrollableBarButton(let height, _, _, _, _, _, _, _):
            return height
        default:
            return 2
        }
    ...
    internal var tabItemHeight: CGFloat {
        ...
        case .barButton(_, _, _, let height, _):
            return height
        case .scrollableBarButton(_, _, _, _, let height, _, _, _):
            return height
    ...
    internal var padding: EdgeInsets {
        ...
        case .segmentedControl(_, let padding, _):
            return padding
        case .scrollableBarButton(_, _, let padding, _, _, _, _, _):
            return padding
        default:
    ...
    internal var placedInToolbar: Bool {
        ...
        case .barButton( _, _, _, _, let placedInToolbar):
            return placedInToolbar
        case .scrollableBarButton( _, _, _, _, _, let placedInToolbar, _, _):
            return placedInToolbar
    ...
    internal var showBottomDivider: Bool {
        switch self {
        case .scrollableBarButton( _, _, _, _, _, _, let showBottomDivider, _):
    ...
    internal var font: Font {
        switch self {
        case .scrollableBarButton( _, _, _, _, _, _, _, let font):
            return font
        default:
